-- Add is_active filter to clients list RPC.
...
grant execute on function public.get_clients_list_filtered(int, int, text, text, text, uuid[], boolean) to authenticated;
